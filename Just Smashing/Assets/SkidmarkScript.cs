...
public class SkidmarkScript : MonoBehaviour {
	...
	void Update () {
        ...
        RaycastHit hit;
        //Find the real pos of the wheelcollider
        ...
        */
        ...
        // a zero rotation.
        if (Mathf.Abs(CorrespondingGroundHit.sidewaysSlip) > .11)
        {
            skidMarkPrefab.gameObject.active = true;
        }
        else if (Mathf.Abs(CorrespondingGroundHit.sidewaysSlip) <= .08)
        {
